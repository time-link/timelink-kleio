...
Changes the handling of automatic ids, both is generating and display. See issue #40
...
*Do not remove automatic ids in databases where record linking exists, because existing identifications will be lost*
