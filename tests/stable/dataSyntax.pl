...
%    cds. 'Cds?' handling code is in the file 'data code'.
%    
...
group-->fillSpace(_S),[(names,N)],dataflag1,{newGroup(N),!}.
...
element(true)          -->[(return,_R)],{!}. %,{name(S,[R]),storeCore(S),!}.%
